        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6 items-start">
            ...
            <div class="lg:col-span-9">
                ...
                <UCard v-if="featuredNews" class="mb-4 sm:mb-8">
                    <template #header>
                        <div class="relative h-[200px] sm:h-[300px] md:h-[400px]">
                            ...
                            <UBadge color="primary" class="absolute top-2 left-2 sm:top-4 sm:left-4">
                                Головна новина
                            </UBadge>
                        </div>
                    </template>
                    ...
                    <template #footer>
                        <div class="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-4">
                            <UButton color="primary" :to="'/news/' + featuredNews.id" block class="sm:w-auto">
                                Читати далі
                            </UButton>
                ...
                <div class="grid gap-4 sm:gap-6">
                    <UCard v-for="news in newsList" :key="news.id" class="flex flex-col sm:flex-row gap-4 sm:gap-6">
                        <img :src="news.image" :alt="news.title" class="w-full sm:w-48 h-48 object-cover rounded" />
                        <div class="flex-1">
                            ...
                            <div class="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-4">
                                <UButton color="primary" variant="soft" :to="'/news/' + news.id" block
                                    class="sm:w-auto">
                                    Читати далі
                                </UButton>
                                <div class="flex gap-2 justify-center">
                ...
                <div class="mt-6 sm:mt-8 flex justify-center">
                    <UPagination v-model="currentPage" :total="100" :per-page="10" :ui="{
            ...
            <div class="lg:col-span-3 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4 sm:gap-6">
                ...
                <UCard class="h-fit">
                    ...
                    <div class="space-y-4">
                        <div v-for="news in popularNews" :key="news.id" class="flex gap-4">
